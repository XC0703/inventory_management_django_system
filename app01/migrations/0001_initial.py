# Generated by Django 3.2.16 on 2022-11-24 14:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wareCount', models.DecimalField(decimal_places=0, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yearSales', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userPower', models.DecimalField(decimal_places=0, default=10, max_digits=3)),
                ('createTime', models.DateTimeField(auto_now_add=True)),
                ('updateTime', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warePower', models.DecimalField(decimal_places=0, default=0, max_digits=3)),
                ('wareCount', models.DecimalField(decimal_places=0, default=0, max_digits=10)),
                ('createTime', models.DateTimeField(auto_now_add=True)),
                ('updateTime', models.DateTimeField(auto_now=True)),
            ],
